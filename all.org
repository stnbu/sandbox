...
- Write an =ls= clone in rust that has the following magical feature: by default, it honors all of you =.gitignore= files, including the one in your home dir. There can just be one extra switch which toggles off this behavior.
...
- The 12 Year Old Dictator [feat. Julian Dennison as Benevolent Leader Kurslaughski] (or his contemporary 12yo equivalent, or an AI) It occurred to me that Sadam (not uniquely), having gotten detached and having to be the loudest scariest bully in the sandbox for his whole life by necessity, his sense of "good taste" generally became juvenile. Shooting guns into the air...building statues of him on a motorcycle... Also, what the fuck else went on with him. Well, story idea -- dictator played by actual insufferable 12 yo. Like, I wonder if Putin ever had anyone tortured to death when the whole world made fun of him riding a shirtless bear, or whatever other thing...
- Sci-Fi horse races -- The intrigue and back-stabbing of actual earth human horse racing, breeding, plantations and hats... but in some epic GoT-like space kingdom. They ride, like, crystal dragons or someshit.
- The things and ideas and "feelings" and activities /between/ people have a life of their own. If a superintelegince had total knowledge of all humans on earth, or maybe just anything contained in the ball of earth ...perfect knowledge, there would be many "structures" and patterns that are human derived but "extrahuman". War is a obvious, very visual example of this. A war is not a person or a people. It's an emergent thing that exists because of people. But the all-knowing super-intelligence(s) could see all the lines and the causation, down to the three drunk Filipino sailors arguing about something in a Yemen speakeasy. It's connected, see. The SI's know (via a series of butterfly-flap causations) that it's connected to the street fighting that will take place two years later in Tibet. It's not connected for /you/ because you're utterly ignorant from their point of view; you're not an SI. The point being: Is there a "story" about /things/ that exist between people? Just like there are not only individual bees but a whole hive that reacts and moves and grows and ebbs as an apparent living thing when standing a few feet away. Could these /things/ have a life of their own? If you visualize the data just right, can all the inter-human stuff be seen as having patterns that appear life-like? Maybe even /aware/? If the humans involved are utterly unaware and if the human-created inter-human /things/ adapt and evolve (memes) and grow and reproduce... where life? where ball?
- There is a doctors office that has both: 1) the take a ticket and wait for your number system and 2) sign in and wait for someone to call your name system. The two overlap. There is only one door. You're not sure whether you should take a number or sign in. Maybe you have to sign in before taking a number. Maybe if you sign in and take a number, you're now in both queues. In any case, it's unclear. This is rich comedy loam. People get yelled at for asking clarifying questions. Who's on first, but with relatable doctor nonsense and hospital confusion.
- Dumb person thinks "morning constitutional" means "saying the pledge of allegiance in the morning"...'like at school'
- A concept where: Some couple has a baby. The baby's first words are "all lizards are tetrapods!" The parents and all who come from far and wide are amazed. By 2 years old the baby is saying things like "use `e**t` for continuously compounded interest" or "In 1864, Rutherford B. Hayes was nominated by Republicans for the House of Representatives from Ohio's 2nd congressional district" ... /Wow/, the people say ... "A dodecahedron has 12 faces" ... /gee!/ ... But no one stops to observe that these are all memorized facts that a baby cannot /learn/, which is by far more miraculous than a "genius child". (bwah)
- intervention catering
- a la /Drunk History/ or possibly /The Honey Badger/ or possibly /Bad Lip Reading/ -- Take a youtube tutorial about something hopefully obscure for most people, say Rust programming. Have someone who knows nothing about the topic do their very best to re-explain what's going on as the tutorial progresses. "Ok, here put the numbers into variable names to store in memory and that lets other functions share them". Maybe like /Björk, Television Talk/.
...
*** Example (probably contradicting something above):
   ...
   Someone can send a copy of everything they post on this secret forum, but no one will know if it's accurate until after block =n=.


** The rest

- Functional Amoeba or Microbial Thinking or An Enzymatic Model of Thought Processing -- The system:
  - Suppose that anything you call a "thought" can be described as a point in some kind of vector space. Said another way, assume that thoughts can be described as a $\gamma$ dimensional vector space over $\mathbb{R}$. Why $\gamma$? Because it's an impossibly huge finite number and they always get greek letters.
  - And you have a system composed of, just to make it simple, a tick during which the state changes...
    - "Your Memories and Thoughts" are points in a gigantic, impossibly-many-dimensional  sea of points in this huge vector space (that is, all of the thoughts you "just had" along with whatever others you can categorize and classify (roll with it)...that's all your "memory". New thoughts are birthed (how? to-be-revealed) and they go right in the huge sea of other "thoughts" (as just defined. Think you can pin me somehow? Try it, Klay Dunkin!)
    - "There are many many pure-function animalcule. These functions (must?) take arguments in the form of one or more "thoughts", they (just for fun) are "pure functions" and they return a set of "new thoughts" which, as stated, are just dumped into the sea of thought-points. "Where?" you ask? Well, they are just points in a vector space, you will have to invent your own sense of "distance"
    - Which brings us to: with each /tick/, these critters (just functions, non-destructively consuming "thoughts" and returning new "thoughts" to file away. That's all they do with each tick. The pool grows! Physical imitations maybe cap things, but your library of thoughts is (at least could be) ever-growing. No matter, much brain matter.
  - What determines what these functions /consume/? Maybe their state changes such that "the nearest =n= thoughts" is deterministic/is calculated. They just slurp up maybe five and let the remainder slip back over the event horizon. It's a /model/, people.
  - But! The internal state of animalcule *could have* called for thoughts =a=, =b=, and =c= with the next tick of the clock, but upon some last-minute recalculations, it turns out someone else has shat out new thought =F= which it turns out is nearer than =c=, so said animalcule goes with =a=, =b=, =F=. Shrug.
  - How many bots! How do they reproduce! Wait, they can reproduce?! Maybe "bots" are more juts a metaphor for "well-tread neural pathways" (You /could/ imagine the "pathways" neuroscientists probably talk about as a kind of wormhole that connects one region of thought-space with another. The two ends drift around and the overall bandwidth can increase based upon feedback; typically /traffic seen lately/ which is everyone's theory. Nother story, but also modelable, seems.)
  - So, what, does the light of consciousness flash into existence when there's enough seething life forms trying to out-reproduce one another? Lay enough eggs? (hmm...)

  IMHO the neat thing going on here is that one could imagine modeling this. A "Just type run and see what happens!" type of thing. Maybe the trick is to stop thinking "oh, I'm going to trace my finger through this and figure out what self-awareness is" and instead just let the ecosystem seethe. With sensors and actuators, it could be a real (and maybe utterly wrong-headed) way to experiment with robot brains: sensor input, crosses some thought-barrier and via some, with guesses, modelable process a _new_ thought is also dropped into the sea of thoughts...maybe to be picked up later by a big fat tardigrade, who has evolved a trait that results in a tweak to its "output", who then shits out some novel and nutritious thought-points. /Maybe/ to be metabolized by some latent life form that has evolved a /trick/ and has just been waiting for this input to make its appearance!

  "Insights"

  - You can have "natural" selection, /resource runs out; extinction/, or you can have arbitrary selection, /More Milk!/, /Tenderer Brisket!/. But it still seems like you can have 'reasonable' selection systems that aren't simply of the life-on-earth sort, e.g. "consume more resources to make more copies". The copies of more efficient schemes result in more copies per unit resource == success.

    Maybe not! What if we have an angry god. Or even just an angry inexplicable situation: /they/ get more resources, /we/ keep losing a bunch of our kind through resource exhaustion. If you're just a dumb animal making copies of yourself, you might not know that there's a simple mechanical computer with gears and cogs that determines how much feed gets dumped into your corner of the cube, or whether same computer might have a turret gun that selects things to destroy for its grand plans.

    "Plans"!, you hear that? If you want to be more realistic, it could be a sealed cube whose only input is "power", which can run lights, whir turrets around, get stingy with the food, all of which is determined by the usual cameras and solenoids and motors and lasers...

    The broader point is that you can imagine such a big rectangle (say barnyard size) that has a cable going to it. Lights for growing vegetables, such as they will grow, a fixed supply of water that gets treated by a hypothetical 1000-year treatment plant, coming out clean, and, cameras and AI and lasers. It has "rules" about selection. There's no decider. It's all deterministic...right?

    Software responds to "too much barley" by zapping some with the lasers or it zaps with pigs dead that have the wrong physique or coloring, based upon Prime Directives. There is no guiding shepherd with a staff. Just software, deterministic given knowledge of starting conditions.

    "What? Huh? ...ok", you say? The model I imagine could have some arbitrary kinds of rules. You want "more thoughts"? Select for that; give more "power" to the productive animalcules. Say, whatever they use "internally" to create a new thought (point) costs (to borrow Ethereum lingo) some "gas". Animalcules that further the Prime Directive just get a bit more, somehow. Also, we can have lasers. Something gone wrong? Zap it out of existence; still just more software.

  - I get a "sense" that the Enzyme analogy might have legs. Firstly, I don't think a productive module will mutate or erase thoughts. Humans get accused of erasing or mutating thoughts. But have you checked =thought_id=? Is it _really_ the same thought? If it has changed, it is not. Yes? So maybe in the interest of simplicity...design bullets:

    - Animalcules have internal memory and "code" (DNA?), but execution, to the end result of excreting another thought, costs energy (mitochondria?). We can have a feeding schedule or whatever kind of arbitrary mechanism for allocation. If it can be measured, we can use it to mechanize resource allocation.

    - Again, thinking simplicity. Animalcules never die, do not reproduce and consume just one thought, what comes out the other end is the same "thought" (plop, back into the sea, not destroyed or altered) and a _new_ thought, if the processes completed (enough gas/energy/ATP). What happens inside is up to the critter. Why not just code and state (memory)? Anything else?

      Well if the code never changes, then we have have no interesting result, except perhaps, "How much of this kind of 'thought' and how much of that, if we let the clock run."

      But how to recode ones self? Reproduction? Viruses? Casual gene swapping? Randomness? It seems like the choice is kind of arbitrary so try all that you can imagine? (The same would apply to...everything else, of course.)

    - How to find the next thought for any given animalcule to slurp? Well, again: endless choices. It seems reasonable to have a kind of "appetite" assigned to each, which again seems like something its "DNA" should handle. In simple terms: have a concept of "distance", which is animalcule-specific.

      Maybe, or, think of it in terms of a "receptor", a "thought" that sits on the end of its nose, and along side that, an algorithm for calculating the distance between the thought on its nose and any other thought in thought-space. In a sense, they are ordered in "nearness" and when the clock ticks, we just feed it the nearest one.

      This could maybe be /more/ simply put: Have an onboard algorithm (organelle) for calculating "nearest thought to me, the animalcule", details not being important.

      Simply feeding random "thoughts" could be something to experiment with.

    - And don't over-complicate it! (er, more simplification) -- Just consider "thoughts" that exist in a vector space of one dimension. The animalcules are just pooping out real numbers. That's it!!...for v0.

    - Need input? Some thought-processing-animalcule could also have its raspy sucker-hole anchored toward the outside world. He gets a bit fatter and more pregnant when he hears someone say that /one word/.

- A rootless filesystem -- you can =cd ../here= and =cd ../there= all day long but you cannot =cd /= and there in fact is no root. How? I donno. I bet it happens on the surface of a torus, though. And it has all kinds of interesting structure. Maybe the rule is: if you =cd ..= enough times you get back to the starting directory. If you =cd ../elsewhere= you are in a different loop, ring... That's a tube of rings, bend it around and make a torus?
- Create a calculator whose input is the time of your birth and whose output is "it is now <this day of the week> (for example on your birthday. "I am $n$ years old today, what day is it today?")
- Mandelbot -- if you are "small" you can "see" finer detail. How about a game universe that takes place on some kind of fractal. You can be any size you want (starting from "one" and getting smaller). As a "small" character you can see detail that the "big" characters cannot. If you are a "big" character, you can see farther and get a "broader view" than a small characters. Each has its merits. Can a game take place on a fractal where the "tension" between the two is leveraged for game play...somehow? Another way of putting: what if there was a game-verse where you could scale your character up and down/larger and smaller and the game detail kept emerging no matter how small you got (because fractal).
- Wants to hang out: an app or "system" that lets you sign up and indicate who your circle of friends is. each account has only one boolean parameter: wants_to_hang_out_soon. when your "network" exceeds some kind of threshold you automatically get a "Let's hang out" notification including everyone who has wants_to_hang_out_soon=yes --> Hang out happens, all of the participants have their wants_to_hang_out_soon=no ... which they are free to reset if the want.
- /A/ Generalization of GoL: something like "humanity" is a bunch of computers interacting using the "senses" as feedback. Why not: a cell is a "turing machine" and there are well-defined "senses". Human is a "program". Cat is a different "program".
- Kinda combining the two: how about one's "avatar" is a python script. It can automatically react to all this "social" stuff for you. Weed out "friends"... longs of stuff "turing complete" [where from comes i/o?]
- /The Sieve of Modern Number Theory/ or /Booring Numbers/ -- Wat would happen if (excluding, say "the evens" and "the odds" and "the multiples of prime $p$) you removed all of the "interesting" numbers from the number line, leaving only the /uninteresting/ numbers...? (and what the hell does that mean?) Or: "what is the most uninteresting finite number greater than 8?"
- Could some kind of fancy contract plus a web UI exist to make it more plausible to just hand someone a hardware wallet, have them plug it in (usb), go to a website (on their computer that they trust) and actually convince them that they really are holding $X, as shown on the website. Signatures. Something?
- =Burn.sol= (is this a thing). Widespread use of =payable(address(0)).transfer(1)= could be made more efficient by "trustless batching": make an obvious contract that just collects....... this doesn't gain us anything does it...?
- Make a python toy: You can use =python -m trace -t foo.py= to print executed lines. Can you print them with leading spaces?? Because if you can, the output should be a program that 1) works and 2) is only the "path" that you took through the program. Especially useful: if you are trying to understand an impossible codebase, do something simple, saving "executed lines with leading spaces" to a file. You can execute just that and disregard all the noise, annotate, yadda yadda. You can then do something slightly less simple, repeat.
- metamaterial with long-lasting chemical /warmth/ -- Making a fancy metamaterial (or "nanostructures" even) to store electricity is hard. But making one to store potential energy of any kind and just "output hear" is a lot easier. Imagined material: It's had like plastic or maybe porcelain or stone. We don't care or notice. It's just "ah, warm" and stays that way for years. There's enough chemical energy in 20 kg of the stuff to blow up a house (maybe. find a number you like.), but that's guaranteed not to happen because it would take more energy to concentrate all the "enmeshed" potential chemical energy. It's got little cells separated by little barriers that self-decompose [or something] at a predictable rate. The "thing" that is made from this stuff [let's say it's a 3d printed baby's crib] is 3d printed in a superfancy way that deposits less of the reactants toward the center where heat dissipates more slowly. Thanks to a lot of supercomputer modeling and endless ruling of the slide, a thing made by this process has /a uniform temperature throughout/. Pretty amazing. And the process also accounts for the way something like this would normally linearly lose its temperature. No! Somehow by mystical materials engineering processés, this stuff holds a fairly flat temperature when plotted against time. Again, it's only chemistry and 3d printing mumbojumbo. No big deal. I imagine that making the "walls" separating the reactants have varying thickness, you could achieve this. Kind of like time-release meds (ever break one of those capsules open...?) Practical application: Make an enclosed box. Do whatever is smart to insulate from the outside, but radiate on the inside. Anyway: box made of above material. This box sits outside in on your front porch or on your back patio. Or on your lanai. You like it because it keeps your cigarette lighter and reading glasses warm. That's all. (ok, think of one yourself!)
- [that recursive remainder arithmetic that whatshisname is so excited about] Any "advancements" in that are very applicable to EVM stuff. EVM /hates/ "fixed" (never mind floating) point values. Arithmetic /all day long/!g
- Timestamping: When I think of timestamping I think of "carefully create my crazy patent", sign it so I can prove I did it first! (like, on blockchain) But [[https://github.com/wonkyweirdy/stramp][since it's so cheap to timestamp things]], why not timestamp every git commit you make? You can point to some code on github (even if it was put there by someone else) and say "I wrote that first. I can prove that I have a copy of that file that predates anything that Github can come up with. And this can be challenged. If some human decides to challenge it, they can look at the timestamp on the copy in the link sent (using Github UI) and if it's after the timestamp proof, then you can exclude this link as "the original source" and go back to assuming that the timestamp proof-haver is the author. This would let you "take credit for code written" entirely on the blockchain. You wouldn't require Githubs cooperation. This could also be done on a per-commit bases, without any (or much) intervention from the developer. You could put a hook in git that gets a timestamp proof for anything _before_ it is pushed to google's central repo. Then, if you link to your own repo, the Github times will be slightly after the timestamp proof, making you still the "presumed author" of that code. What happens if you find "prior art"? I wonder if you could "slash" someone that's making such false claims.
- `CCBuyout.sol` -- A DAO-like thing that lets benefactors put money into a pool for the purpose of "buying out" a particular IP-encumbered work of art, giving the whole pot to the "owner" of said art if they transfer said art into the public domain. Like all these things: plenty of loose ends. But consider: you have a favorite book that you think everyone should read. It's just that great (for whatever reason). You value the idea of putting this book into the public domain enough to commit 1.0 Ether. You and many others put money into this pool until the "owner" is faced with a decision: continue to collect $0.03 per purchase of my hard work until the end of time OR collect this pot of $7m and publicly declare that "Everyone Poops" is now public domain/creative commons/no license. I started thinking in terms of [[https://blkcipher.pl/assets/pdfs/Handbook_of_Elliptic_and_Hyperelliptic_Curve_Cryptography.pdf][this red-hot piece of stolen property]]. But there are probably books/works out there where there is more demand for such a thing. The great part: Either you get what you signed up for (you get "book is public domain for my 1.0 Ether") OR, after some timeout, the pot drains back to the original contributors and you lose nothing. Whether Wither. What happens if they signed a contract with Penguin that has all the holes patched up and is airtight as far as any /lawyer/ can see? It goes to court, the judge asks "did you collect this money? were you drunk? do you realize the contract supersedes that?" ...even in that case, this shading thing that the author of Everyone Poops did will give people who illegally download it just one more excuse for why it's not immoral. "Are you kidding me? That motherfucker got $7m. We /know/ that he did! Fuck his 'agreement' with Penguin. I'm downloading this bitch." At a certain point, the threshold is exceeded, the balance tips, the camel's back is broken, the house of cards comes tumbling down. Does it matter what a judge says if /Planet Human/ thinks quite the contrary? Similarly, there could have been a =FreeTheSlaves.sol= at different points in time. How much trouble will the cops go to to chase down and return your slave if they KNOW that you got a stack of money in exchange for this thing that you /thought/ you owned but apparently do no longer. Shame on you, Curly.
- Timestamping: When I think of timestamping I think of "carefully create my crazy patent", sign it so I can prove I did it first! (like, on blockchain) But since it's so cheap to timestamp things, why not timestamp every git commit you make? You can point to some code on github (even if it was put there by someone else) and say "I wrote that first. I can prove that I have a copy of that file that predates anything that Github can come up with. And this can be challenged. If some human decides to challenge it, they can look at the timestamp on the copy in the link sent (using Github UI) and if it's after the timestamp proof, then you can exclude this link as "the original source" and go back to assuming that the timestamp proof-haver is the author. This would let you "take credit for code written" entirely on the blockchain. You wouldn't require Githubs cooperation. This could also be done on a per-commit bases, without any (or much) intervention from the developer. You could put a hook in git that gets a timestamp proof for anything _before_ it is pushed to google's central repo. Then, if you link to your own repo, the Github times will be slightly after the timestamp proof, making you still the "presumed author" of that code. What happens if you find "prior art"? I wonder if you could "slash" someone that's making such false claims.
- I'm sure it's already a thing: Your "wallet" (crypto hardware) could have a completely automated system that creates ephemeral keys for some purpose, lets you go on using that (ephemeral) key for signing, then periodically the system needs user intervention to sign (using your "real", secure key) the signatures of your ephemeral key. How to make this "consumable"? Maybe the ephemeral key signatures have a "reference" to the block of "real" key batch signatures its included in. You could include this "reference" before the batch gets signed. If no one can find the batch signature, it can be assumed that the batch never got created (or signed). So, you could use an ephemeral key in some automated system and just sign the batches once per day (for example.) Each batch sign (could) triggers an ephemeral key rotation (and/or a timeout: only 24hrs say).
- check out trueblocks.io
- Can you allegorically do the following: Reach into a pool of non-fungible assets and grab, as nearly as possible, =n= Ether worth of assets (or the same for your favorite token/coin, but not fiat). It may be useful some day to easily and convincingly hand over a big pile of low-worth non-fungible tokens as payment for something. It'd be cool if this could be done in a way that doesn't make everyone nervous. Obviously you will need to know the value of these things. You would want to ensure that no single assets dominates your "basket" (for the same reason investors are supposed to "diversify" -- it's analogous).
- NFT all the things -- How do you digitize a thing? Embedding a "chip" has lots of downsides. Etching in a QR code has lots of downsides. For the sake of argument, let's forget about somehow "integrating a physical thing" to give an physical thing (ultimate vagueness on purpose) a digital identity. A better idea might be to have a standardized system for identifying an object (as unique or as one of many other identical "things" -- [non]fungible) in a way that's similar to how a human would do it, but more precise, elaborate, and ...er... "capturable". Here is a practical example:
  1. Work for years and years on an AI system that can identify cars in a way that is convincing and satisfactory to humans. What can it do? It can identify year, make, model, color ...and also if this is /your/ red Tesla Model 3 or your cousin Larry's red Tesla Model 3. It may also say "cannot tell" in rare cases or "the front half is yours the back half is someone else's." It has memorized every little paint chip, every little, dimple in the upholstery, the distance between the shift lever, when in park, to the center of the rear bumper's furthest-aft location... all down to the micrometer. It's trained and trained and oh how it is trained. At some point we have a "release". "This thing recognizes cars."
  1. THEN, the AI is somehow described "completely" and (sorry) tokenized, or at least documented extensively, including the big binary blob that represents its brain... in a way that maybe even a future civilization could grok. Maybe it's a "self extracting executable"... whatever. It's all done somehow, and all of that gets summarized with the output of a hash function. This "automobile recognition system" has identity =0x1f2bd97c0...=
  1. That same carefully-defined, unambiguous piece of software (with the right corresponding hash to identify it) can now be used to "identify" individual vehicles. (But wait, we lost the AI software... NO YOU DIDN'T!)
  1. Now every car can potentially get ID by this system: roll it into the "studio", place in park, roll down all the windows and walk away. A robotic camera and whatever else, spends an hour poking and prodding at your vehicle until it's done documenting all the /literally billions/ of metrics it has used to say: this is car =0xc19e36c50d...=. While all this seems like a lot of info, we can always summarize it with a single hash and also it pales in comparison to trying to uniquely identify faces!
  1. Your car, even if you run it into a telephone pole and it burns to a crisp, can still be brought back to "the studio" to get identified. The system will say X% sure this is car =0xc19e36c50d...=
  The "studio" could be used for many many things... the algorithm could be optimized for "cars", "diamonds", "paintings"... And each such algorithm (AI encapsulation) can be defined clearly and also can be summarized with a hash (along with a URL showing where to download this "self extracting executable".)
- =get_most_distant()= -- Imagine a 3D space bounded by [0,1]. In other words, a unit cube. Now suppose there is one point we've chosen =(a, b, c)=. The job of =get_most_distant()= is to return the point that is most "remote" in this space. if =a==b==c==0= then the highest-scoring point is probably =a==b==c==1=,  but what about when those two points are already "taken". My inspiration: automatically assign "easily distinguishable" colors to users in some "anonymous" system. Each time you pick a new color for a new user, you want to find the color "most different" from all the existing chosen colors (although with color it's not only "distance"...)
- There's no reason that /real/ crypto currency couldn't make its way over to "the testnet side" in a controlled, logical fashion. What do I mean: testnets help push progress forward. Testnet node runners are hobbyists, probably, mostly, or many of them may be vested interests (firms that use mainnet). But if there's any need for more "volunteer" work on the testnet side, it could be incentivized with "real money". This could be via a contract or some such, or it could be baked into the base protocol. You run a test node? Good, if we can confirm that, we can also drop =n= Ether into the same wallet on mainnet as a thank you (from a volunteer fund). Do we want to incentives testnet to have 90% client A and 10% client B for testing purposes? We can adjust that with rewards. Which leads us to
- MyTestNet.sol -- If you can describe the parameters that you want in a test network, say ... you want a certain version of client used. Or you want to simulate breakage in some controlled way, or throughput... anything you can describe in a file (seems like) could be achieved by structuring rewards for testnet node runners. Some orchestration software (like 'puppet') could be used to, without user input, read a spec, examine what the rewards are for certain configurations, select the configuration that maximizes your rewards, start running the node. You can be compensated for doing what you're most needed for automatically. I mean, this could possibly be broadened to "anything puppet can do which can also be confirmed". So can you publish a contract, put some money in it, and watch your botnet emerge? Hmmmm.
- I think there's a call for a "service" that will give you a "report" about a crypto address: "it looks like a bot", "it is definitely a coinbase address", "this address just got charged up with some tokens and has no other activity". There's heuristics and pretty pie charts... Maybe this is etherscan. Or at least Etherscan will get around to it.
- Think about, if you have a well-reputed wallet, you can sign some data and (for example) post it somewhere on your Youtube channel. That might just be "posting your address with more steps". One cute thing, if this lead to directly funding Youtubers, they would try to stamp it out. Cool thought experiment: what if you were trying to obfuscate "proof of something" (e.g. a signature)? If there was a secret database that YT did not have access to, you could show "instructions" in there for how to extract the (let's face it, just) data from the Youtube channel page. I might be combining a new idea with an old, worn out idea.
- Spam.sol -- If it becomes possible to "message a wallet" (and I think it will), what would you say to wallet X? Importantly, if this mirrors the way that ethereum clients work, you will need to explicitly be receiving messages from some address (potentially all), so someone would have to just "listen for all messages" in order to receive blindly-sent messages. Maybe this isn't so crazy. There are so many addresses that no one is going to spam everyone (um, right?) It might make sense to just receive all messages and deal with "spam" in some other way. I can imagine coordinating with Old Whales as a group. I would imagine they will have a reason to coordinate some day.
