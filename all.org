...
- [idea] The King's Purse:
  - Guard to page: The King comeith. Fetch The King's Purse!
  - Page to guard: What, the whole thing?
  - Guard to page: Don't argue with me you pissant. Do it now!
  - <time passes>
  - Page comes into frame with a wheelbarrow full of gold, jewelry and shit. He's also balancing a large Chest on his head and has a "wench" (peasant's daughter) on his shoulders. She helps to stabalize the chest so he can use both hands on the wheelbarrow. His arms are also draped in gold chains (and shit). Bits of loose change (gold coins) spill over.
  - Guard to page: What the bloody hell is this!?
  - Page to guard: You said to fetch The King's Purse (I "eard" you).
...
- Seems like MM as a "provider" is different from, e.g. http network providers in an important way: some thing or other about MM as a provider makes it easier to compile to wasm. Something about ...networking? ...threading? There are issues about it in the `rust-web3` Github repo.
